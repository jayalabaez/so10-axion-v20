...
def main() -> int:
    ...
    run(
        [
            ...
            "test_g3_sigma_hypercharge_audit_v20.py",
    ...
    core = [
        ...
        ROOT / "g3_sigma_hypercharge_audit_v20.py",
        ...
        ROOT / "test_g3_sigma_hypercharge_audit_v20.py",
        ...
        ROOT / "G3_SIGMA_HYPERCHARGE_AUDIT_V20.json",
        ROOT / "G3_SIGMA_HYPERCHARGE_AUDIT_V20.md",
