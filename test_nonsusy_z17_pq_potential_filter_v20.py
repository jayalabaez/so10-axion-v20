...
class TestDeclaredFilter:
    ...
    def test_status_and_flags(self):
        ...
        assert not flags["z17_pq_x_filter_applied"]
        assert not flags["continuous_x_filter_applied"]
        assert flags["phi17_low_dimension_terms_retained"]
    ...
    def test_declared_no_x_behavior(self):
        ...
        assert self.report["historical_continuous_X_comparison"][
            "Phi17^3_status"
        ] == "CHARGE_FORBIDDEN"
        assert self.report["historical_continuous_X_comparison"][
