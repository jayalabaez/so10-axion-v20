...
import prototype_phi_zero_o10_degree8_invariant_split as invariant_split
...
EXPECTED_SHA256 = {
    ...
    HERE / "prototype_phi_zero_o10_degree8_invariant_split.py": (
        "6a80a8f95efc1f4515b8b8e9120c4011df5d378ebeb38f59f6119c73308daa90"
    ),
    HERE / "_scratch_phi_zero_degree8_exact_unisolvent.py": (
        "0bdb091d506a1fc180dbd68fa1c32b7bdb09084a78bcf86ebedad2aa2d2bc9f6"
    ),
    HERE / "_scratch_phi_zero_degree8_exact_solve.py": (
