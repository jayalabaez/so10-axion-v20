...
def build_report() -> dict:
    ...
    return {
        ...
        "verdict": (
            ...
            "supernova QCD-axion bound is passed. However, the v20 fermion "
            "coupling gap is NOT closed: exact C_e, C_p and C_n remain conditional "
            "on the unspecified heavy-light portal matching. The 37 GHz photon "
            "benchmark remains an open direct-search target."
        ),
    }
