...
import prototype_phi_self_zero_global_sextic_syzygy as sextic
import prototype_phi_zero_cubic_cauchy_bridge as cubic_bridge
import prototype_phi_zero_degree8_conductor_identity as conductor
...
EXPECTED_DEPENDENCIES = {
    HERE / "prototype_phi_zero_degree8_conductor_identity.py": (
        "92c5b244daa40ec423c6292f3816f6c87395ce31fe7aebe73dd264a5596f44df"
    ),
    HERE / "prototype_phi_zero_cubic_cauchy_bridge.py": (
        "01b1bb5f450521506bf6a025650629691ce738325d1f16c5aafc050abe34e1c7"
    ),
    HERE / "prototype_phi_self_zero_global_sextic_syzygy.py": (
    ...
    HERE / "prototype_signed_kaehler_full126_physical_subtraction_corollary.py": (
