...
def _build_report_from_ledger(gate_report: dict[str, Any]) -> dict[str, Any]:
    ...
    verdict = (
        ...
        "vacuum is rejected. The fixed-P branch with this Delta_R orientation is "
        "exactly excluded and its lower replacement has the wrong gauge symmetry. "
        "The SU(5)+Delta Phi/Sigma orbit is an exact global SOS minimum with a "
        "12-dimensional stabilizer (SU(3)_c x SU(2)_L x U(1)_T3R, not the SM: its Delta_R has Y=-1) and "
        ...
        "global vacuum. The fixed-P branch with this Delta_R orientation is "
        "exactly excluded and the lower replacement has the wrong gauge symmetry. "
        "The SU(5)+Delta Phi/Sigma branch is an exact global SOS minimum with a "
        "12-dimensional stabilizer (SU(3)_c x SU(2)_L x U(1)_T3R, not the SM: its Delta_R has Y=-1) and rank/nullity 429/33. A chiral-H "
        "extension is exactly stationary and BFB with the expected symmetry "
        "ranks. Its source-bound 486-real Hessian is exactly "
        ...
        "Hessian is certified separately). The historical "
        "64/91 calculation "
