...
kernel dimension 12028. The exact physical target is now constructed in the
full 6585-row graded chart, together with all 22 standard PSD-coordinate
routes: nine real-type congruences and thirteen complex blocks directly in
standard Hermitian coordinates. The full target has common denominator
1728000 and 845 nonzero entries. The coefficient map reparameterized in those
standard coordinates, SDP feasibility or infeasibility certificates, and
exact primal PSD or dual Farkas certificates remain open. No arbitrary-$\Phi$
bound, G3 closure,
or whole-model conclusion follows from cubic or quartic surjectivity. Uniform coercive
control for arbitrary non-pure-$\Delta_R$ $\Sigma$ orientations is also open. The
