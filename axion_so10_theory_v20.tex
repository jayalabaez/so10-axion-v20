...
kernel dimension 12028. The physical quartic target and the congruences from
the exact real-type fixed bases to standard real symmetric PSD coordinates
have not been constructed. The physical G3 gap target, the full
$6585\times19594$ Schur matrix, and SDP feasibility or infeasibility
certificates therefore remain open. No arbitrary-$\Phi$ bound, G3 closure,
