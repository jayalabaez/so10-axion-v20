...
class StrictRGAuditTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        for module,name in (
            ...
            (ps,"PATI_SALAM_YUKAWA_MATCHING_V20_VERDICT.json"),
            (cert,"THEORY_CERTIFICATION_MATH_V20_VERDICT.json"),
            (posterior,"PORTAL_YUKAWA_POSTERIOR_V20_VERDICT.json"),
            (halo,"HALOSCOPE_37GHZ_LIMIT_COMPARE_V20_VERDICT.json"),
            (vac,"UV_VACUUM_ALIGNMENT_V20_VERDICT.json"),
            (rge2,"YUKAWA_RGE_2LOOP_V20_VERDICT.json"),
            (lik,"FCNC_EXACT_LIKELIHOOD_V20_VERDICT.json"),
        ):
