...
def _finite_lifetimes(obj: Any, path: str = "") -> list[dict[str, Any]]:
    """Collect positive finite values whose key denotes a lifetime in years."""
...
def build_report() -> dict[str, Any]:
    ...
    gauge_envelope_max = dict(envelope.get("maximum_lifetime_point") or {})
    ...
    # A model-level proton-decay failure requires an unavoidable prediction.
    # The current tree does not yet derive unique X/Y masses, triplet masses,
    # scalar Yukawa contractions and relative phases simultaneously.
